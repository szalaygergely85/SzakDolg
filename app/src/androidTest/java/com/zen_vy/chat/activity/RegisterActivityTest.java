...
public class RegisterActivityTest {
         ...
         .check(
            matches(
               hasTextInputLayoutErrorText(
                  context.getString(R.string.display_name_is_required)
               )
            )
         );
   ...
   public void testPasswordDoNotMatch() {
      onView(withId(R.id.editTextRegEmail))
         .perform(ViewActions.replaceText(TestUtil.createRandomEmail()));
   ...
   public void testExistingEmailAddress() {
      ...
      onView(withId(R.id.editTextRegName))
         .perform(ViewActions.replaceText(RandomUtil.getRandomString(10)));
      onView(withId(R.id.editTextPass1)).perform(ViewActions.replaceText(pass));
      onView(withId(R.id.editTextPass2)).perform(ViewActions.replaceText(pass));
      ...
      onView(withId(R.id.edtRegEmail))
         .check(
            matches(
               hasTextInputLayoutErrorText(
                  context.getString(R.string.email_is_already_registered)
               )
            )
         );
   ...
   @Test
   public void registerNewUser_Success_RedirectsToProfile()
      throws InterruptedException {
      onView(withId(R.id.editTextRegEmail))
         .perform(
            replaceText("test" + RandomUtil.getRandomString(5) + "@zenvy.com")
         );
      ...
      String token = SharedPreferencesUtil.getStringPreference(
         context,
