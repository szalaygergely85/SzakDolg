...
public class LoginActivityTest {
    ...
    public void testLoginUIElements() {
        ...
        onView(withId(R.id.edtLgnEmail)).check(matches(isDisplayed()));
    ...
    public void testSuccessfulLoginWithoutError() {
        ...
        doNothing().when(mockUserApiHelper).loginUser(
                eq(context),
        ...
        onView(withId(R.id.edtLgnEmail)).perform(ViewActions.replaceText("test@example.com"));
        onView(withId(R.id.edtLgnPass)).perform(ViewActions.replaceText("password"));
    ...
    public void testMissingFieldsError() {
        ...
        onView(withId(R.id.txtLgnError)).check(matches(withEffectiveVisibility(ViewMatchers.Visibility.GONE)));
