...
public class XMLUtil {
    public static String convertToXml(Map<String, Object> map, String rootElement) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (entry.getValue() instanceof Map) {
                ...
                xmlBuilder.append(convertToXml((Map<String, Object>) entry.getValue(), entry.getKey()));
            } else {
