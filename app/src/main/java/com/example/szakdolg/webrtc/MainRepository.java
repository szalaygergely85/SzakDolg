...
public class MainRepository implements WebRTCClient.Listener {
    ...
    public void sendCallRequest(String target){
        ...
        signalServiceManager.sendMessage(new DataModel(target,currentUsername,null, DataModelType.StartCall).getJSON());
    }
       ...
       signalServiceManager.setServiceConnectionListener(
                new SignalServiceManager.ServiceConnectionListener() {
                    ...
                    public void onServiceConnected() {
                        ...
                        // Now you can connect
                        signalServiceManager.connect(AppConstants.WS_URL, currentUsername); // Replace with actual user ID if needed
                    }
