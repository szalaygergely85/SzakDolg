...
public class ContactsRepositoryImpl implements ContactRepository {
    ...
    @Override
    public void getContact(Long contactId, String authToken, Callback<Contact> callback) {
        ...
        if (contact != null) {
            ...
            // Fetch from API
            contactApiService.getContact(contactId, authToken).enqueue(new Callback<Contact>() {
                @Override
    ...
    @Override
    public void updateContact(Contact contact, String authToken, Callback<Void> callback) {
