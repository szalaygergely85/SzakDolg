...
public class UserRepositoryImpl implements UserRepository{
    ...
    @Override
    public void searchUser(String search, String token, Callback<List<User>> callback) {
...
_userApiService.addUser(user).enqueue(new Callback<User>() {
    @Override
    public void onResponse(Call<User> call, Response<User> response) {
        if(response.isSuccessful()){
    ...
    @Override
    public void getPublicKeyByUserId(Long userId, String token, Callback<String> callback) {
