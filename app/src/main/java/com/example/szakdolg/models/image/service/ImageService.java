...
public class ImageService {
   ...
   public void addPicture(Uri imageUri, Long userId, String tags, final ImageService.ImageCallback callback) {
      ...
      if (mimeType != null && (mimeType.startsWith("image/"))) {
         ...
         imageLocalHelper.saveImageToDisk(context, currentUser, imageEntity, new ImageLocalHelper.ImageSaveCallback() {
            @Override
            public void onImageSaved(ImageEntity updatedImage) {
               ...
               if (picUri != null) {
                  ...
                  if (file.exists()) {
                     ...
                     imageRepository.uploadImage(body, imageEntity, currentUser.getToken(), new Callback<ResponseBody>() {
                        @Override
