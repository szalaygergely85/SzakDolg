...
import static com.zen_vy.chat.util.KeyStoreUtil.getPrivateKey;
...
public class EncryptionHelper {
   ...
   public static String encrypt(String message, String publicKeyString) {
      ...
      try {
         ...
         byte[] encryptedMessageBytes = encryptCipher.doFinal(
            secretMessageBytes
         );
         encodedMessage =
   ...
   public static String decrypt(String message, String privateKeyString) {
      ...
      try {
         ...
         decryptedMessage =
         new String(decryptedMessageBytes, StandardCharsets.UTF_8);
      } catch (
