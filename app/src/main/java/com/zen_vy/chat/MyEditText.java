...
public class MyEditText extends AppCompatEditText {
      ...
      new InputConnectionCompat.OnCommitContentListener() {
         ...
         public boolean onCommitContent(
            ...
            if (keyBoardInputCallbackListener != null) {
               keyBoardInputCallbackListener.onCommitContent(
                  inputContentInfo,
                  flags,
                  opts
               );
   ...
   public void setKeyBoardInputCallbackListener(
      KeyBoardInputCallbackListener keyBoardInputCallbackListener
   ) {
